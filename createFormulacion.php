...
if (!empty($data->id_pcnte) && !empty($data->nmro_evlcion)) {
    ...
    echo json_encode([
        "status" => "error", 
        "message" => "Los campos 'id_pcnte' y 'nmro_evlcion' son obligatorios."
