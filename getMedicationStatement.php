...
// 5. Instanciar el objeto MedicationStatement e invocar su método
$medicationStatement = new MedicationStatement($db);
$resultado = $medicationStatement->GetInfoMedicationStatement($idPcnte);
