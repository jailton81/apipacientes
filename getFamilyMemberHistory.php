...
// 5. Instanciar el objeto FamilyMemberHistory e invocar su método
$familyHistory = new FamilyMemberHistory($db);
$resultado = $familyHistory->GetInfoFamilyMemberHistory($idPcnte);
