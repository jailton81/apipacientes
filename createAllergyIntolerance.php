...
if (!empty($data->id_pcnte) && !empty($data->tipoalergia)) {
    ...
    $result = $allergyModel->createAllergyIntolerance($data);
    ...
    echo json_encode([
        "status" => "error", 
        "message" => "Los campos 'id_pcnte' y 'tipoalergia' son obligatorios."
