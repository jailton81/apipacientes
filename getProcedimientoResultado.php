...
// 5. Instanciar el objeto ProcedimientosResultados e invocar su método
$procedimientosResultados = new ProcedimientosResultados($db);
$resultado = $procedimientosResultados->GetInfoProcedimientoResultado($idPcnte, $cnsctvoPcnte);
