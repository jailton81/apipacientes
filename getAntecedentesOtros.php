...
require_once __DIR__ . '/models/AntecedentesOtros.php';
...
// 5. Instanciar el objeto AntecedentesOtros e invocar su método
$antecedentesOtros = new AntecedentesOtros($db);
$resultado = $antecedentesOtros->GetInfoAntecedenteOtro($idPcnte);
