...
if (!empty($data->id_pcnte) && !empty($data->parentesco) && !empty($data->descripcion)) {
    ...
    $result = $familyModel->createFamilyMemberHistory($data);
    ...
    echo json_encode([
        "status" => "error", 
        "message" => "Los campos 'id_pcnte', 'parentesco' y 'descripcion' son obligatorios."
