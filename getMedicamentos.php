...
require_once __DIR__ . '/models/Medicamentos.php';
...
// 5. Instanciar el objeto Medicamentos e invocar su método
$medModel = new Medicamentos($db);
$resultado = $medModel->GetInfoMedicamento($search);
